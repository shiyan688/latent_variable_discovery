...
def workflow_config_from_json(data: dict[str, Any]) -> WorkflowConfig:
    return WorkflowConfig(
        ...
        validation_label_count=data.get("validation_label_count", 0),
        test_label_count=data.get("test_label_count"),
        label_split_mode=data.get("label_split_mode", "shared"),
        train_samples_per_label=data["train_samples_per_label"],
        validation_samples_per_label=data.get("validation_samples_per_label"),
        ...
        calibration_split_mode=data.get("calibration_split_mode", "prefix"),
        ...
        optimization_schedule=data.get("optimization_schedule", "joint"),
        theta_lr=data.get("theta_lr"),
        q_lr=data.get("q_lr"),
        theta_steps_per_cycle=data.get("theta_steps_per_cycle", 1),
        q_steps_per_cycle=data.get("q_steps_per_cycle", 1),
        loss_weighting=data.get("loss_weighting", "static"),
        gradnorm_warmup_steps=data.get("gradnorm_warmup_steps", 0),
        gradnorm_interval=data.get("gradnorm_interval", 1),
        gradnorm_alpha=data.get("gradnorm_alpha", 0.5),
        gradnorm_lr=data.get("gradnorm_lr", 0.025),
        gradnorm_min_weight=data.get("gradnorm_min_weight", 1e-3),
        gradnorm_max_weight=data.get("gradnorm_max_weight", 1e3),
        gradnorm_record_trace=data.get("gradnorm_record_trace", False),
        device=data["device"],
        quiet=data["quiet"],
