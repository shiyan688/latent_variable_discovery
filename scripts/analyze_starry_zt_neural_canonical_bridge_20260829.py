#!/usr/bin/env python3
"""Aggregate the frozen 15-cell Starry ZT neural canonical-q bridge."""
...
ROOT = PROJECT_ROOT / "runs/starry_zt_neural_canonical_bridge_20260829"
ANALYSIS_ROOT = ROOT / "analysis"
PLAN = PROJECT_ROOT / "STARRY_ZT_NEURAL_CANONICAL_BRIDGE_PLAN_20260829.md"
RUNNER = PROJECT_ROOT / "scripts/run_starry_zt_neural_canonical_bridge_20260829.py"
EXPECTED_PLAN_SHA256 = "1b7d1d41052694004f05167634359ee377939ac1b6f959672e07d41a8fb32323"
EXPECTED_RUNNER_SHA256 = "45d98629e99b6fe58435351c44f4e4ebaa79bd5a6a247886b50d63e2ec7ec251"
FAMILIES = (
    "raw_decoder",
    "raw_q_ridge_req",
    "functional_degree1",
...
def main() -> None:
    ...
    decision = {
        "scope": "Starry ZT development neural-to-canonical q bridge",
